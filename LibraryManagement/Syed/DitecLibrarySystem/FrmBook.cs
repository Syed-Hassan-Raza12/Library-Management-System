...
namespace DitecLibrarySystem
{
    public partial class FrmBook : Form
    {
        ...
        {
   bool result = DataLink.runCommand("INSERT INTO tbl_book ( BookName, BookPrice, Author, Category, Status ) values ('"+txtBookName.Text+"','"+txtBookPrice.Text+"','"+txtAuthor.Text+"','"+cmbCategory.Text+"','Available');");
          if (result)
          {
